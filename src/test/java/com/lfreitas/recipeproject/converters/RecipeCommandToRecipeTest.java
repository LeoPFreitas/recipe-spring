...
import com.lfreitas.recipeproject.commands.NotesCommand;
import com.lfreitas.recipeproject.commands.RecipeCommand;
import com.lfreitas.recipeproject.domain.Difficulty;
...
class RecipeCommandToRecipeTest {
    ...
    void convert() {
        ...
        assertEquals(COOK_TIME, ((Recipe) recipe).getCookTime());
